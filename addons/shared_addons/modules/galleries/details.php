	...
	public function info()
	{
		return array(
			...
			'description' => array(
				...
				'pl' => 'Modu? pozwalaj?cy tworzy? galerie zdj??.',
				...
				'cs' => 'Silný modul pro vytvá?ení a správu galerií obrázk?.',
				...
				'lt' => 'Galerijos modulis leidžia vartotojams kurti nuotrauk? galerijas'
			),
			'frontend' => TRUE,
			'backend' => TRUE,
			'menu' => 'content',
