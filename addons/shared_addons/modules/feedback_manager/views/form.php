            ...
            <div class="tabs">
                <div class="form_inputs" id="book-content-tab">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label"><?php echo lang('feedback_manager:form_description') ?></label>
                        ...
                        <div class="control-group">
                            <label class="control-label"><?php echo lang('feedback_manager:form_require') ?></label>
                            <div class="input"><?php echo form_input('require', $post->require, 'maxlength="100" class="width-20"') ?></div>
                        </div>

                        <div class="control-group">
                            <label class="control-label"><?php echo lang('feedback_manager:form_status') ?></label>
