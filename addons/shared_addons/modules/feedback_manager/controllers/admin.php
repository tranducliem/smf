...
class Admin extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $pagination = create_pagination('admin/feedback_manager/index', $total_rows);
    ...
    public function create(){
        ...
        if ($this->form_validation->run())
        {
            ...
            ($this->input->post('btnAction') == 'save_exit')
                ? redirect('admin/feedback_manager')
                : redirect('admin/feedback_manager/edit/'.$id);
    ...
    public function edit($id = 0){
        $id or redirect('admin/feedback_manager');
