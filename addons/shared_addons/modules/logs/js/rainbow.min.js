/* Rainbow v1.1.9 rainbowco.de | included languages: generic, scheme, php */
...
Rainbow.extend('log', [{'name': 'meta','pattern': /([A-Za-z]*) - ([0-9]{4}-[0-9]{2}-[0-9]{2}) ([0-9]{2}:[0-9]{2}:[0-9]{2})/gi},], true);