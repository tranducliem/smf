<table class="table table-striped">
    ...
    <tr>
        ...
        <th>{{ helper:lang line="feedbacktype:form_title" }}</th>
        <th>{{ helper:lang line="feedbacktype:form_description" }}</th>
    ...
    {{ if posts }}    
        ...
        {{ /posts }}
    {{ else }}
        <tr><td colspan="5" >{{ helper:lang line="feedbacktype:currently_no_type" }}</td></tr>
    {{ endif }}
    </tbody>
</table>
